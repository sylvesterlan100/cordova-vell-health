...
public class RespiratoryRateFunctions {
    public static KClass<? extends Record> dataTypeToClass() {
        return kotlin.jvm.JvmClassMappingKt.getKotlinClass(RespiratoryRateRecord.class);
    }

    public static void populateFromQuery(Record datapoint, JSONObject obj) throws JSONException {
        RespiratoryRateRecord rrDP = (RespiratoryRateRecord) datapoint;
    ...
    //     RespiratoryRateRecord record = new RespiratoryRateRecord(
